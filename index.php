		...
		<main class="container-fluid">
			<div class="row py-4">
				<div class="col-12">
					...
					<p class="lead">
						Kickstart your project with a variety of reusable, stylish, modular widgets. These widgets utilize the core <span class="font-weight-bold">Bootstrap</span> components, so they <em>don't</em> require extra libraries or scripts to function.
					</p>
				</div>
			</div>
									...
									<div class="col-lg-6 my-2">
										<div class="card card-body p-3"><span class="text-primary"><span class="badge badge-primary float-right">+ 13%</span> Sign-ups </span>
											<div class="progress mt-4">
												<div class="progress-bar w-25 bg-primary wow slideInLeft" style="visibility: hidden; animation-name: none;"></div>
											</div>
										</div>
									</div>
									<div class="col-lg-6 my-2">
										<div class="card card-body p-3"><span class="text-primary"><span class="badge badge-primary float-right">80%</span> Usage </span>
											<div class="progress mt-4">
												<div class="progress-bar w-75 wow slideInLeft" style="visibility: hidden; animation-name: none;"></div>
											</div>
										</div>
									</div>
									<div class="col-lg-6 my-2">
										<div class="card card-body p-3"><span class="text-primary"><span class="badge badge-primary float-right">78</span> Bursts </span>
											<div class="progress mt-4">
												<div class="progress-bar bg-primary w-75 wow slideInLeft" style="visibility: hidden; animation-name: none;"></div>
											</div>
										</div>
									</div>
									<div class="col-lg-6 my-2">
										<div class="card card-body p-3"><span class="text-success"><span class="badge badge-success float-right">+ 26%</span> Returning </span>
											<div class="progress mt-4">
												<div class="progress-bar bg-success w-25 wow slideInLeft" style="visibility: hidden; animation-name: none;"></div>
											</div>
										</div>
									</div>
									<div class="col-lg-6 my-2">
										<div class="card card-body p-3"><span class="text-primary"><span class="badge badge-primary float-right">201</span> Sales </span>
											<div class="progress mt-4">
												<div class="progress-bar w-50 bg-primary wow slideInLeft" style="visibility: hidden; animation-name: none;"></div>
											</div>
										</div>
									</div>
									<div class="col-lg-6 my-2">
										<div class="card card-body p-3"><span class="text-success"><span class="badge badge-success float-right">+ 74%</span> Pageviews </span>
											<div class="progress mt-4">
												<div class="progress-bar bg-success w-75 wow slideInLeft" style="visibility: hidden; animation-name: none;"></div>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="row my-3">
							...
							<div class="col-sm-6">
								<div id="accordion" class="accordion">
									<div class="card card-default panel"><a href="" data-toggle="collapse" data-parent="#accordion" data-target="#collapseOne" class="card-header text-white bg-dark"><span class="card-title">
                                            Accordion Item 1
                                        </span></a>
										...
										</div> <a href="" data-toggle="collapse" data-parent="#accordion" data-target="#collapseTwo" class="card-header text-white bg-dark collapsed"><span class="card-title">
                                           Accordion Item 2
                                        </span></a>
										...
										</div> <a href="" data-toggle="collapse" data-parent="#accordion" data-target="#collapseThree" class="card-header text-white bg-dark collapsed"><span class="card-title">
                                          Accordion Item 3
                                        </span></a>
			...
			</section> <span id="comments" class="anchor"></span>
			<section class="py-4 mt-2">
				<div id="comments" class="comments row">
					<div class="col-12 mb-4">
						<h3 class="mb-4">Comments</h3>
						<div class="comment mb-3 row">
							<div class="comment-avatar col-lg-1 col-md-2 col-4 text-center">
								<a href=""><img src="//placehold.it/80" alt="avatar" class="mx-auto rounded-circle img-fluid"></a>
							</div>
							<div class="comment-content col-lg-11 col-md-10 col-12">
								<h6 class="small comment-meta"><a href="#">admin</a> | Today, 2:38</h6>
								<div class="comment-body">
									<p>
										Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod <a href="">link to a page</a> tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris
										nisi ut aliquip ex ea commodo.
										<br> <a href="" class="text-right small"><i class="ion-reply"></i> Reply</a></p>
								</div>
							</div>
							<div class="comment-reply col-lg-11 col-md-10 col-12">
								<div class="row">
						...
						<div class="row pt-2">
							<div class="col-12"><a href="" class="btn btn-sm btn-primary">Comment</a></div>
						</div>
					</div>
				</div>
			</section> <span id="alerts" class="anchor"></span>
			<section class="py-4 mt-2">
				<div class="row">
					<div class="col-md-12">
						...
						<div class="row mt-2">
							<div class="col-lg-6">
								<div class="card card-default">
									<h4 class="card-header"><a href="#" data-target="#collapseMe" data-toggle="collapse" class="float-right"><i class="align-middle md_18 material-icons">more_vert</i></a>
										Heading
									</h4>
							...
							<div class="col-lg-6">
								<div id="accordion2" class="accordion">
									<div class="card"><a data-toggle="collapse" href="" data-parent="#accordion2" data-target="#collapseOne2" class="card-header"><span class="card-title">
                                            Panel 1
                                        </span></a>
										<div id="collapseOne2" class="card-body collapse show">
										...
										</div> <a data-toggle="collapse" href="" data-parent="#accordion2" data-target="#collapseTwo2" class="card-header collapsed"><span class="card-title">
                                            Panel 2
                                        </span></a>
										<div id="collapseTwo2" class="card-body collapse">
											<p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. Officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor,
										...
										</div> <a data-toggle="collapse" href="" data-parent="#accordion2" data-target="#collapseThree2" class="card-header collapsed"><span class="card-title">
                                            Panel 3
                                        </span></a>
										<div id="collapseThree2" class="card-body collapse">
											<p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf
												moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. samus labore sustainable VHS.
											</p>
										</div>
					...
					<div class="col-md-12">
						...
						<div class="row mt-2">
							...
							<div class="col-lg-5 pb-2">
								<h3>Heading 3</h3>
								<h3><a href=""><span class="badge badge-dark">badge</span></a> <a href=""><span class="badge badge-success">success</span></a> <a href=""><span class="badge badge-danger">danger</span></a> <div class="w-100 my-3"></div> <a href=""><span class="badge badge-warning">warning</span></a> <a href=""><span class="badge badge-info">info</span></a> <a href=""><span class="badge badge-primary">primary</span></a> <div class="w-100 my-3"></div> <a href=""><span class="badge badge-pill badge-dark">pill</span></a> <a href=""><span class="badge badge-pill badge-success">100k</span></a> <a href=""><span class="badge badge-pill badge-info">2</span></a> <a href=""><span class="badge badge-pill badge-danger">378</span></a> <a href=""><span class="badge badge-pill badge-warning">tag</span></a> <a href=""><span class="badge badge-pill badge-primary">1123</span></a></h3></div>
						</div>
					</div>
				</div>
			</section>
